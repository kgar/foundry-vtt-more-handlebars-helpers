...
import gt from './helpers/gt.mjs';
import gte from './helpers/gte.mjs';
import lt from './helpers/lt.mjs';
import lte from './helpers/lte.mjs';
...
Hooks.on('ready', function () {
  ...
  Handlebars.registerHelper(`${CONSTANTS.MODULE_ID}-gt`, gt);
  Handlebars.registerHelper(`${CONSTANTS.MODULE_ID}-gte`, gte);
  Handlebars.registerHelper(`${CONSTANTS.MODULE_ID}-lt`, lt);
  Handlebars.registerHelper(`${CONSTANTS.MODULE_ID}-lte`, lte);
